# Generated by Django 4.1.3 on 2023-01-10 16:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expcreatorid', models.ForeignKey(blank=True, db_column='expCreatorID', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('expdatasetid', models.ForeignKey(blank=True, db_column='expDatasetID', null=True, on_delete=django.db.models.deletion.SET_NULL, to='expAI.datasets')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configaftertrainmodelpath', models.CharField(blank=True, db_column='expAfterTrainModelPath', max_length=200, null=True)),
                ('configfilelog', models.CharField(blank=True, db_column='expFileLog', max_length=100, null=True)),
                ('configevaluateid', models.ForeignKey(blank=True, db_column='configEvaluateID', null=True, on_delete=django.db.models.deletion.CASCADE, to='expAI.evaluations')),
                ('configexpid', models.ForeignKey(blank=True, db_column='configExpID', null=True, on_delete=django.db.models.deletion.CASCADE, to='expAI.experiments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_last', models.BooleanField(blank=True, db_column='is_last', default=False, null=True)),
                ('configid', models.ForeignKey(blank=True, db_column='configID', null=True, on_delete=django.db.models.deletion.CASCADE, to='expAI.paramsconfigs')),
            ],
        ),
        migrations.CreateModel(
            name='Results',
            fields=[
                ...
                ('resultconfigid', models.ForeignKey(blank=True, db_column='resultConfigID', null=True, on_delete=django.db.models.deletion.CASCADE, to='expAI.paramsconfigs')),
                ('resulttestingdataset', models.ForeignKey(blank=True, db_column='resultTestingDataset', null=True, on_delete=django.db.models.deletion.SET_NULL, to='expAI.datasets')),
            ],
            options={
                'db_table': 'results',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datatype', models.CharField(blank=True, db_column='datatype', max_length=200, null=True)),
